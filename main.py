...
FONTS = {
    ...
    "ruika": "fonts/HappyRuika-07 (1).TTF",
    "shinonome": "fonts/JF-Dot-Shinonome14.ttf",
    "tanuki": "fonts/TanukiMagic.ttf"
}
...
def make(name, id, content, icon, font_path="fonts/MPLUSRounded1c-Regular.ttf"):
    img = BASE_IMAGE.copy()
    ...
    tsize_t = drawText(img, (890, 270), content, font=font_path, size=55, color=(255, 255, 255, 255), split_len=20)
...
def colorMake(name, id, content, icon, font_path="fonts/MPLUSRounded1c-Regular.ttf"):
    img = BASE_IMAGE.copy()
...
def reverseMake(name, id, content, icon, font_path="fonts/MPLUSRounded1c-Regular.ttf"):
    img = BASE_IMAGE.copy()
    ...
    tsize_t = drawText(img, (390, 270), content, font=font_path, size=55, color=(255, 255, 255, 255), split_len=20)
...
def reverseColorMake(name, id, content, icon, font_path="fonts/MPLUSRounded1c-Regular.ttf"):
    img = BASE_IMAGE.copy()
...
def whiteMake(name, id, content, icon, font_path="fonts/MPLUSRounded1c-Regular.ttf"):
    img = BASE_IMAGE.copy()
    ...
    tsize_t = drawText(img, (890, 270), content, font=font_path, size=55, color=(0, 0, 0, 0), split_len=20)
...
def reverseWhiteMake(name, id, content, icon, font_path="fonts/MPLUSRounded1c-Regular.ttf"):
    img = BASE_IMAGE.copy()
    ...
    tsize_t = drawText(img, (390, 270), content, font=font_path, size=55, color=(0, 0, 0, 0), split_len=20)
...
def generate():
    ...
    font_key = request.args.get("font") or "mplus"
    font_path = FONTS.get(font_key, FONTS["mplus"])

    if type == "color":
        return send_file(
            colorMake(name, id, content, icon, font_path),
            mimetype="image/png"
        )
    elif type == "reverse":
        return send_file(
            reverseMake(name, id, content, icon, font_path),
            mimetype="image/png"
        )
    elif type == "reverseColor":
        return send_file(
            reverseColorMake(name, id, content, icon, font_path),
            mimetype="image/png"
        )
    elif type == "white":
        return send_file(
            whiteMake(name, id, content, icon, font_path),
            mimetype="image/png"
        )
    elif type == "reverseWhite":
        return send_file(
            reverseWhiteMake(name, id, content, icon, font_path),
            mimetype="image/png"
        )
    else:
        return send_file(
            make(name, id, content, icon, font_path),
            mimetype="image/png"
        )
